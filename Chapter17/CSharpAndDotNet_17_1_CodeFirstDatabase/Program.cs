...
using (BookContext db = new BookContext())
{
    ...
    foreach (var store in query)
    {
        ...
        {
            WriteLine($"-Title:{stock.Item.Title} code: {stock.Item.Title}");
...
public class BookContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer(@"Data Source=LAPTOP-L9UAJNP2;Database=Book;Integrated Security=True");
    }
}
